node(){
    ...
    stage('cloning'){
        echo "cloning"
        checkout([$class: 'GitSCM', branches: [[name: '*/$BRANCHNAME']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'a14b9e5e-a271-40ee-be77-eb6595ff5342', url: 'https://github.com/csenapati12/sept-repo.git']]])
    }
    stage('building'){
        echo "building"
